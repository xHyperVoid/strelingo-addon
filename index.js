...
const builder = new addonBuilder({
    ...
    description: 'Provides dual subtitles (main + translation) from OpenSubtitles for language learning. Find the source code at: https://github.com/Serkali-sudo/strelingo-addon',
    resources: ['subtitles'],
    types: ['movie', 'series'],
    idPrefixes: ['tt'],
