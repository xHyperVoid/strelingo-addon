...
const builder = new addonBuilder({
    ...
    description: 'Provides dual subtitles (main + translation) from OpenSubtitles for language learning. <br><a href="https://github.com/Serkali-sudo/strelingo-addon">GitHub</a>',
    resources: ['subtitles'],
    types: ['movie', 'series'],
    idPrefixes: ['tt'],
